...
const firebaseConfig = {
    ...
    storageBucket: "neelam-enterprises-1810.appspot.com",
...
export const db = getFirestore(app);  // ✅ This is important
// export const storage = getStorage(app); // ✅ Optional if you are uploading profile pic
