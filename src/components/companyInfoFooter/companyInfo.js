...
export default function CompanyInfo() {
    return (
        <div className="flex justify-center items-center py-16 max-sm:py-8 max-lg:py-12">
            <div className="w-full flex flex-col xl:mx-20 px-4 xl:px-20 lg:px-10 max-w-[1310px]">
                ...
                <div className="flex max-md:flex-col">
                    <div className="basis-1/2">
                        ...
                        <p className="py-2">
                            {options.address}, {!!options.landmark && options.landmark !== '' ? <p>Landmark: {options.landmark}, </p> : <></>} {options.city} - {options.zip}, {options.state}
