        ...
        <footer className="flex justify-center items-center text-sm text-footer-gray dark:text-gray-400 bg-gray-100 dark:bg-gray-900">
            <div className="flex max-xl:flex-col justify-center max-w-[1310px]">
                ...
                <div className="flex justify-center items-center max-md:flex-col">
                    ...
                    <p className="px-1">Phone No:<a className='text-orange pl-1 opacity-60' href="tel:+917415939251">+91-7415939251</a></p>
                    <p className="pl-1">Email:<a className='text-orange pl-1 opacity-60' href="mailto:chauhanharshvardhansingh4@gmail.com">chauhanharshvardhansingh4@gmail.com</a></p>
                </div>
            </div>
        </footer>
    );
